...
public class EmployeeProfileView extends AppCompatActivity {
    ListView listView;
        ...
        dataRequest.sendRequest(
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        if (dataRequest.statusCode == 200 || dataRequest.statusCode == 304) {
                            Toast.makeText(EmployeeProfileView.this, response.toString(), Toast.LENGTH_SHORT).show();
                            try {
                            ...
                            Toast.makeText(EmployeeProfileView.this, String.valueOf(dataRequest.statusCode), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EmployeeProfileView.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }

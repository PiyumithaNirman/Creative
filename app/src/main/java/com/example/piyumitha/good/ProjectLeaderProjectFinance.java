        ...
        request.sendRequest(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ProjectLeaderProjectFinance.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
                        ...
                        if (convertView == null) {
                            ...
                            buttonAdd.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(ProjectLeaderProjectFinance.this, ManagerAddTransactionActivity.class);
                            ...
                            buttonView.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent intent = new Intent(ProjectLeaderProjectFinance.this, ManagerViewFinanceActivity.class);
                                    intent.putExtra("projectId", getItem(position).projectId);
                                    startActivity(intent);}
                            });
                        }
